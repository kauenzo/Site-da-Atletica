...
const heroImage = '/assets/calourada.jpeg'
      ...
      <div className='relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto'>
        <div className='space-y-6 md:space-y-8'>
          ...
          <div className='flex justify-center mb-6 md:mb-8'>
            <div className='w-26 h-24 sm:w-32 sm:h-32  rounded-full shadow-hero flex items-center justify-center'>
          ...
          {/* <h1 className="font-bignoodle text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-black text-atletica-white leading-none tracking-wider">
            <span className="text-gradient">CAVALO</span>
            <br />
            DE TROIA
          </h1> */}
