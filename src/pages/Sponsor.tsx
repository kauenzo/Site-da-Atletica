...
const additionalBenefits = [
  {
    ...
    description: "Exposição da sua marca em todos os eventos universitários, atingindo mais de 3.000 estudantes ativamente."
  },
  {
    icon: TrendingUp,
    title: "Networking Estratégico",
    description: "Acesso direto aos melhores talentos em tecnologia e futuros profissionais da área."
  },
  {
    icon: Award,
    title: "Impacto Social",
    description: "Contribuição direta para o desenvolvimento esportivo e educacional da comunidade universitária."
  },
  {
    icon: Handshake,
    title: "Parcerias Duradouras",
    description: "Oportunidades de colaboração em projetos de inovação e desenvolvimento tecnológico."
  }
];
...
const Sponsor = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!selectedPlan || !formData.name || !formData.email || !formData.company) {
      toast({
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-atletica-burgundy max-w-4xl mx-auto leading-relaxed">
            ...
            Juntos, podemos transformar sonhos em realidade e formar os profissionais do futuro.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {additionalBenefits.map((benefit, index) => {
              ...
              return (
                <Card key={index} className="bg-atletica-white shadow-button hover-lift text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan) => (
              ...
              >
                ...
                <CardHeader className={`${plan.color} text-atletica-white text-center py-8`}>
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    {plan.features.map((feature, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center gap-3 text-sm text-atletica-burgundy">
                  ...
                  <div className="space-y-3">
                    {plan.benefits.map((benefit, index) => (
                      <div key={index} className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-atletica-burgundy">{benefit}</span>
                      </div>
                    ))}
                  </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-atletica-burgundy font-medium">
                      Nome Completo *
                    </Label>
                    <Input
                      id="name"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-atletica-burgundy font-medium">
                      E-mail *
                    </Label>
                    <Input
                      id="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="company" className="text-atletica-burgundy font-medium">
                      Empresa *
                    </Label>
                    <Input
                      id="company"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-atletica-burgundy font-medium">
                      Telefone
                    </Label>
                    <Input
                      id="phone"
                ...
                <div className="space-y-2">
                  <Label htmlFor="plan" className="text-atletica-burgundy font-medium">
                    Plano de Interesse *
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-atletica-burgundy font-medium">
                    Mensagem
                  </Label>
                  <Textarea
                    id="message"
